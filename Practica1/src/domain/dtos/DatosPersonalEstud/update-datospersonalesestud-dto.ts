export class UpdateDatosPersonalesEstudDto {
    ...
    private constructor(
      ...
      public readonly idUbicacion: string,
    ...
    static create( props: {[key:string]: any} ): [string?, UpdateDatosPersonalesEstudDto?]  {
      ...
      return [undefined, new UpdateDatosPersonalesEstudDto(id, calle, avenida, telefono, idUbicacion)];
    }
